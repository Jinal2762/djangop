# Generated by Django 3.2.7 on 2021-12-11 14:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bloodgrp_tyep', models.CharField(max_length=5)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='b_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bbank_admin.bloodbank'),
        ),
        migrations.AddField(
            model_name='blood_stock',
            name='bloodgrp_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bbank_admin.blood_grp'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='appointment',
            name='d_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bbank_admin.donor'),
        ),
    ]
