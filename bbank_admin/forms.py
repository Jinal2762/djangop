...
class ReceiverForm(forms.ModelForm):
    class Meta:
        model = Receiver
        fields = ["receiver_id", "first_name", "last_name", "bloodgrp_id", "Gender", "email", "dob", "receiver_weight", "contact_no", "id_proof", "home_number", "address", "state", "username", "password", "area_id"]
